...
st.info("La altura de montaje es la distancia desde el piso hasta donde están instaladas las luminarias.")

altura_plano_trabajo = st.number_input("Altura del plano de trabajo (m)", min_value=0.5, value=0.75, step=0.05)
st.info("La altura del plano de trabajo es donde se realiza la tarea visual. Por ejemplo, una mesa de trabajo suele estar a 0.75 m.")
area = longitud * ancho
...
st.markdown("""
#### 🧠 ¿Qué significa el valor del CU?
| Rango de CU | Interpretación |
|-------------|----------------|
| 0.3 – 0.49  | Bajo: Pérdidas altas. Superficies muy oscuras o mala distribución. |
| 0.50 – 0.64 | Moderado: Puede mejorar. Reflejos aceptables. |
| 0.65 – 0.80 | Bueno: Buen aprovechamiento de luz. Diseño eficiente. |
| > 0.80      | Excelente: Óptimo, ideal en oficinas, laboratorios, quirófanos. |
""")
