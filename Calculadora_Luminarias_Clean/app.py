...
st.markdown("Calcula el número de luminarias o los lux proporcionados en un espacio conforme a la norma. Ajusta CU, MF y reflectancia para un diseño más preciso.")
...
st.info("**Altura de montaje:** Es la distancia desde el piso hasta el punto donde se instalan las luminarias.")

altura_plano_trabajo = st.number_input("Altura del plano de trabajo (m)", min_value=0.5, value=0.75, step=0.05)
st.info("**Altura del plano de trabajo:** Es la altura de la superficie donde se realiza la tarea visual. Por ejemplo, una mesa suele estar a 0.75 m.")
area = longitud * ancho
